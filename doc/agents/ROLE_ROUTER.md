...
Read `apps/hft-recorder/AGENTS.md` first. Use this router together with the root `doc/agents/ROLE_ROUTER.md`; the local recorder rules are stricter and take precedence.
