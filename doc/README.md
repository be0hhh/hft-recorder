...
5. `ARCHITECTURE.md`
6. `TRIANGLE_BASE_ARCHITECTURE_AUDIT.md`
7. `VALIDATION_AND_RANKING.md`
8. `REPLAY_TO_CXETCPP_FANOUT.md`
9. `COMPRESSED_REPLAY_FLOW.md`
10. `STREAMS.md`
11. `CONFIG_AND_CLI.md`
12. `TESTING_CONTRACT.md`
13. `BUILD_AND_ISOLATION.md`
