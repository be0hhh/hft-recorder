...
Emitted from `src/Runtime/src/Metrics/Metrics.cpp`. Registered with `prometheus::Registry`; the
...
- `CodingStyle.md` § "Logging" — wrapper rule.
- `ErrorHandlingAndGaps.md` — which metric fires for each incident row.
- `BENCHMARK_PLAN.md` — 28-cell research grid.
- `ConfigAndCli.md` — env variables that enable / disable push.
