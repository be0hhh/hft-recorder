...
//
// Steps (see docs/Variants/Trade/Var01RawZstdCpp/README.md for full context):
...
//
// Hard rules (docs/CodingStyle.md):
//   - noexcept, Status-return, no exceptions, no heap alloc in this function.
//   - in and out buffers may not alias.
//
// Reference: docs/ExternalLibraries.md §zstd, docs/CodecVariants.md row ZSTD.
// ─────────────────────────────────────────────────────────────────────────────
