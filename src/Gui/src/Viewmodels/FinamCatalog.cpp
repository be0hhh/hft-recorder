...
QString finamCatalogSourcePath() {
    return QDir(QCoreApplication::applicationDirPath())
        .absoluteFilePath(QStringLiteral("../src/gui/src/data/finam_assets.json"));
}

QByteArray readFinamCatalogBytes() {
#if defined(HFTRREC_SOURCE_DIR)
    QFile sourceFile(QStringLiteral(HFTRREC_SOURCE_DIR) + QStringLiteral("/src/Gui/src/Data/FinamAssets.json"));
