...
#include "../../../Runtime/src/Replay/EventRows.hpp"
...
class ChartItem : public QQuickPaintedItem {
  ...
  private:
    ...
    std::uint8_t hoveredStrategyFillReason_{0};
    std::uint8_t hoveredStrategyFillLiquidity_{0};
    std::int64_t hoveredStrategyFillOrderQtyE8_{0};
    std::int64_t hoveredStrategyFillCumulativeFilledQtyE8_{0};
    std::int64_t hoveredStrategyFillRemainingQtyE8_{0};
    std::int64_t hoveredStrategyFillAvgPriceE8_{0};
    std::int64_t hoveredStrategyFillBookLevelQtyE8_{0};
    std::int64_t hoveredStrategyFillBookVisibleExecutableQtyE8_{0};
    std::int64_t hoveredStrategyFillBookConsumedPctE8_{0};
    std::int64_t hoveredStrategyFillQueueAheadBeforeE8_{0};
    std::int64_t hoveredStrategyFillQueueAheadAfterE8_{0};
    std::uint32_t hoveredStrategyFillChunkIndex_{0};
    std::uint32_t hoveredStrategyFillChunkCount_{0};
    std::int64_t hoveredStrategyFillExecutionQtyE8_{0};
    std::int64_t hoveredStrategyFillExecutionAvgPriceE8_{0};
    std::int64_t hoveredStrategyFillReferencePriceE8_{0};
    std::int64_t hoveredStrategyFillSlippageE8_{0};
    std::int64_t hoveredStrategyFillSlippageBpsE8_{0};
    std::int64_t hoveredStrategyFillExecutionBookConsumedPctE8_{0};
