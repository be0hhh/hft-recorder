...
class WorkspaceViewModel : public QObject {
  ...
  private:
    ...
    QStringList tabOrder_{QStringLiteral("capture"), QStringLiteral("viewer"), QStringLiteral("compress"), QStringLiteral("backtests"), QStringLiteral("quant"), QStringLiteral("results")};
